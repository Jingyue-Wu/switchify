            ...
            <div className='font-manrope p-10'>
                <div className='h-[100vh]'>
                    <div className='flex items-center justify-center flex-col'>
                        <a href='#how-it-works' className='text-[17vw] select-none'>Switchify</a>
                    </div>
                    <div className='text-right mr-[8vw] mb-96'>
                        ...
                        <Link to="/transfer" className='hover:underline text-[5vw] md:text-[2vw] lg:text-[1.5vw] break-words lg:max-w-[40vw] ml-auto text-gray-300'>Try it out for free →</Link>
                        <div className='w-[13vw] h-[1px] bg-gray-300 ml-auto my-5'></div>
                    </div>
                </div>

                <div className='text-left ml-[8vw] mb-64'>
                    <h1 className='text-[8vw] md:text-[4vw] lg:text-[6vw] break-words mr-1-auto' id='how-it-works'>How it Works ...</h1>
                    ...
                    <h3 className='text-[5vw] md:text-[2vw] lg:text-[1vw] break-words lg:max-w-[40vw] mr-auto mt-6'>Note: due to current API limits, there is a 10 song limit at the moment </h3>
                </div>
